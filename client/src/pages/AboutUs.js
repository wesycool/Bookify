            ...
            <div className="devInfo col-12 col-md-3 shadow p-3 m-2 mb-5">
                <div className="cards h-100 d-inline-block">
                    ...
                    <div className="card-Content">
                        ...
                        <div class="link">
                            <a href="https://samuelyoo.github.io/portfolio/" rel="noopener noreferrer" target="_blank" class="btn btn-secondary m-1" data-toggle="tooltip" data-placement="top" title="Portfolio"><h2 style={{margin:'0px'}}><i class="fas fa-globe-americas"></i></h2></a>
